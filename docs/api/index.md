...
| [test-smoke-boundaries](../../test-docs/smoke/test_boundaries.md) | A test-doc (FEAT-CONFIGV2-017): the `symbols` region below is generated by `cdmon` from `tests/smoke/test_boundaries.py` — the marker-lint smoke checks that keep the test taxonomy honest — and drifts whenever a test there is added, renamed, or removed. The test file is the source of truth (K2); this catalog is graded against it, never the reverse. |
| [test-smoke-smoke](../../test-docs/smoke/test_smoke.md) | A test-doc (FEAT-CONFIGV2-017): the `symbols` region below is generated by `cdmon` from `tests/smoke/test_smoke.py` — the bootstrap import/version smoke test — and drifts whenever a test there changes. The test file is the source of truth (K2); this catalog is graded against it, never the reverse. |
<!-- CDM:END api-index -->
